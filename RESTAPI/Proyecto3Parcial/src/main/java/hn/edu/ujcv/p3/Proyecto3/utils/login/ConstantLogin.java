package hn.edu.ujcv.p3.Proyecto3.utils.login;

public final class ConstantLogin {
    ...
    public static final String URL_BASE_LOGINS = String.format("%s/logins" , URL_BASE);
}
